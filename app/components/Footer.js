        ...
        <>
            ...
            <div className="footer-text-container row text-start">
                ...
                <div className="col-md-2">
                    ...
                    <p><FaPhone className="me-3 primary-text-color" />(+91) - 982 367 3892</p>
                    <p><MdEmail className="me-3 primary-text-color" />gotrip@gmail.com</p>
                    <p><FaLocationDot className="me-3 primary-text-color" />400143, MUMBAI </p>
                </div>
                <div className="col-md-1"></div>
                <div className="col-md-2">
                    <span className='border border-primary me-2 my-1'></span>
