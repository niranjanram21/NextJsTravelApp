...
export default function NavBar() {
  ...
  return (
    <div
      className={`navbar py-3 mt-4 navbar-expand-lg position-fixed z-4 transition-all ${
        isScrolled ? "scrolled-navbar" : "bg-body-transparent"
      }`}
    >
      <div className="container d-flex justify-content-between align-items-center">
        <RiMenu2Line onClick={toggleSidebar} className="navbar-brand fs-2 toggleButton me-3" />
        <Link
          href="/"
          className="navbar-brand montserrat-unique-class fs-3 fw-bolder d-flex align-items-center"
        >
        ...
        <div className="collapse navbar-collapse poppins-medium">
          <ul className="navbar-nav mx-auto fw-semibold">
            ...
            <li className="nav-item mx-2">
              <Link
                href="/hotels"
                className={`nav-link ${activeTab === "hotels" ? "navtabs-color fw-bold" : ""}`}
            ...
            <li className="nav-item mx-2">
              <Link
                href="/destination"
                className={`nav-link ${
                  activeTab === "Destinations" ? "navtabs-color fw-bold" : ""
                }`}
          ...
          <div className="d-flex gap-4">
            <span>
              <button className="search-button w-100 px-4 py-2" onClick={() => handleTabClick("")}>
                Search
              </button>
            </span>
