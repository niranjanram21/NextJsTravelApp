...
export default function SideBar() {
  ...
  return (
    <>
      <div
        className={`sidebar-container h-100 px-2 position-fixed z-5 text-start py-4 shadow-lg ${
      ...
      >
        <div className="d-flex justify-content-between align-items-center mb-3">
          <Link
            href="/"
            className="navbar-brand text-black montserrat-unique-class fs-3 fw-bolder d-flex align-items-center"
          >
        ...
        <ul className="nav nav-pills flex-column mb-auto ">
          ...
          <li className="nav-item">
            <Link
              href="/blogs"
              className={`nav-link  ${activeTab === "Blogs" ? "navtabs-color fw-bold" : ""}`}
